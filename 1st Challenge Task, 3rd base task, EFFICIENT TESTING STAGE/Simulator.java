...
public class Simulator {
    ...
    private static final double MYCOPLASMA_PROB = 0.4;
    private static final double CHAMELEON_PROB = 0.6;
    private static final double ADJMYCO_PROB = 0.8;
    ...
    for (int row = 0; row < field.getDepth(); row++) {
        for (int col = 0; col < field.getWidth(); col++) {
            ...
            if (randomVal1 <= MYCOPLASMA_PROB) {
                ...
                cells.add(myco);
            } else if (randomVal1 <= CHAMELEON_PROB) {

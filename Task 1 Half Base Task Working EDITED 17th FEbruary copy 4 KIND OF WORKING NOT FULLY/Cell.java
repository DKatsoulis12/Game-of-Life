...
public class Cell {
    ...
    public void act() {
        ...
        if (!isAlive()) {
            if (mycoNeighbours == 3) {
                ...
                fieldStats.incrementCount(Mycoplasma.class);
                //Cell cell = new Mycoplasma(getField(), getLocation(), Color.ORANGE);
    ...
    for (Cell neighbour : neighbours) {
        ...
        if (classI.isInstance(neighbour)) {
            count++;
        }
    }

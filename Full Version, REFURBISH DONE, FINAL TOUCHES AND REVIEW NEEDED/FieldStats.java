...
public class FieldStats {
    ...
    /**
     * Obtains the number of objects of a specific class in the Field. It is used by the AdjustiveMycoplasma class, since its objects change their reproductive rate depending on their overall population
     * @param cellClass the class whose objects in the field will be counted
     * @return the number of objects in the field for the class requested
       */
    public int getCellCount(Class cellClass){
        Counter info = counters.get(cellClass);
    ...
    /**
     * Decrement the count for one class of life
     * @param cellClass The class of cell to decrement.
     */
    public void decrementCount(Class cellClass) {
        Counter count = counters.get(cellClass);

...
public class Mycoplasma extends Cell {
    ...
    */
    ...
    System.out.println("Before act(): " + getField().getObjectAt(getLocation()).getClass().getName());
    ...
    System.out.println("After act(): " + getField().getObjectAt(getLocation()).getClass().getName());
}

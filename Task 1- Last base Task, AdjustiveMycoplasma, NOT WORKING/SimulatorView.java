...
//originally
    ...
    public static final int numOfGenerations = 50;
    ...
    new Thread(() -> {
        for (int gen = 0; gen <= numGenerations; gen++) {
            ...
            simulator.delay(1000);  // Adjust the delay as needed
            Platform.runLater(() -> {
                updateCanvas(simulator.getGeneration(), simulator.getField());
            });
            try {
                Thread.sleep(1000);  // Introduce a slight delay for synchronization
